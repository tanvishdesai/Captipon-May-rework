...
grad_clip_norm = 5.0
max_caption_length = 75 # Max length for PADDED captions (subword tokens might be more)
...
def main():
    ...
    criterion = nn.CrossEntropyLoss(ignore_index=vocab.pad_idx) # Use pad_idx from SP vocab
    optimizer = optim.Adam(model.parameters(), lr=learning_rate, betas=(0.9, 0.98), eps=1e-9, weight_decay=1e-5) # Adam params often used for Transformers
